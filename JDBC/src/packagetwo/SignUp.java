    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == clear) {
            ...
            String insertValue = String
                .format(
                    "INSERT INTO TOMISIN VALUES ('%s', '%s')", 
...
//            String query1 = "DROP TABLE IF EXISTS TOMISIN";
//            st.execute(query1);
//            String query = "CREATE TABLE TOMISIN (ID INT PRIMARY KEY, Name varchar(50));";
//            st.execute(query);
//            System.out.println("Query executed");
...
//            System.out.println("Statement created");
//            String query = "CREATE TABLE TOMISIN (USERNAME VARCHAR(20), PASSWORD VARCHAR(20));";
//            st.execute(query);
//            System.out.println("Query executed");
//        } catch (SQLException e) {
//            System.out.println("Error occured: " + e.getMessage());
